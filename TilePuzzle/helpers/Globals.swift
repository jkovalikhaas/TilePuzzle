...
class Globals {
	...
	static let numImages = 276
	static let totalCatagories = 20
	static let catagories = ["pets", "cats", "deer", "farm", "smam", "lmam", "pred", "prim",
							"sbirds", "lbirds", "amph", "rept", "seam", "fish", "bugs", "flowers", "land1", "land2", "color", "cities"]
	static let numCatagories = [12, 13, 14, 17, 14, 12, 15, 15, 16, 14, 12, 13, 12, 14, 15, 14, 16, 16, 10, 12]
	...
	static let catagoryTitles = ["Pets", "Big Cats", "Hooved Animals", "Farm Animals", "Small Mammals",
								...
								"Small Reptiles", "Large Reptiles", "Marine Life", "Fish", "Bugs", "Flowers",
								"Landscapes 1", "Landscapes 2", "Colors", "Cities"]
}
